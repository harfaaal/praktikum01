...
<body>
    ...
    $siswa = new Mahasiswa (02120,'Aulia Harfa Lutfisa');
    $siswa->thn_angkatan = 2021;
    $siswa->prodi = 'SI';
    $siswa->ipk = 3.9;

    $siswa1 = new Mahasiswa (02121,'Anisa Wahyuni');
    $siswa1->thn_angkatan = 2021;
    $siswa1->prodi = 'SI';
    $siswa1->ipk = 3.9;
    
    $siswa2 = new Mahasiswa (01011,'Dhia Aulia');
    $siswa2->thn_angkatan = 2010;
    $siswa2->prodi = 'SI';
    $siswa2->ipk = 3.8;

    $siswa3 = new Mahasiswa (01012,'Muhammad Ayyas');
